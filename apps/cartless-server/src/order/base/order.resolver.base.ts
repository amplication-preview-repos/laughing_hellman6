...
import { Sneaker } from "../../sneaker/base/Sneaker";
...
export class OrderResolverBase {
  ...
  async createOrder(@graphql.Args() args: CreateOrderArgs): Promise<Order> {
    return await this.service.createOrder({
      ...
      data: {
        ...
        sneaker: args.data.sneaker
          ? {
              connect: args.data.sneaker,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => Sneaker, {
    nullable: true,
    name: "sneaker",
  })
  async getSneaker(@graphql.Parent() parent: Order): Promise<Sneaker | null> {
    const result = await this.service.getSneaker(parent.id);
